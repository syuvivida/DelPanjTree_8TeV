...
#        'file:/data2/syu/testsample/AbelianZprime_hZ_qqll_LHC8_M1000.root'
...
if runOnMC:
    ...
    ### CA8Jet
process.tree.CA8jecPayloadNames = cms.vstring(CA8jecLevels)
process.tree.CA8jecUncName = cms.string(CA8jecUnc)
process.tree.AK5jecPayloadNames = cms.vstring(AK5jecLevels)
process.tree.AK5jecUncName = cms.string(AK5jecUnc)
